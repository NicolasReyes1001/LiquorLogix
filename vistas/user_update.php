...
<div class="container is-fluid mb-6">
 ...
 <div class="has-text-centered mb-5"> 
    <h1 class="title is-3 has-text-info"> 
        <br><br> 
        <i class="fas fa-search"></i>Actualizar datos de cuenta</h1>
		<h2 class="subtitle">Actualicemos los datos de tu cuenta</h2>
	<?php }else{ ?>
		<div class="container is-fluid mb-6">
 <div class="has-text-centered mb-5"> 
    <h1 class="title is-3 has-text-info"> 
        <br><br> 
        <i class="fas fa-search"></i>Actualizar usuario</h1>
		<h2 class="subtitle">Actualicemos los datos del usuario</h2>
	<?php } ?>
</div>
...
<div class="box">
	...
	<form action="./php/usuario_actualizar.php" method="POST" class="FormularioAjax" autocomplete="off" >
		...
		Para actualizar la contraseña de este usuario, por favor complete ambos campos. Si no desea cambiar la contraseña, deje ambos campos vacíos.
		</p>
		<br>
		<div class="columns">
			<div class="column">
